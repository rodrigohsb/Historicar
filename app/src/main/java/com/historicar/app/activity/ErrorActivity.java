...
public class ErrorActivity extends AppCompatActivity
{
    ...
    public boolean onCreateOptionsMenu (Menu menu)
    {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener()
        {
            ...
            {
                if (!ValidateUtils.isOnline(ErrorActivity.this))
                {
                    ...
                    AlertDialog alertDialog = new AlertUtils(ErrorActivity.this).getAlertDialog(getString(R.string.invalid_connection), button);
                    alertDialog.show();
                    return false;
                }
                else if (!ValidateUtils.validatePlate(s))
                {
                    ...
                    AlertDialog alertDialog = new AlertUtils(ErrorActivity.this).getAlertDialog(getString(R.string.invalid_plate), button);
                    alertDialog.show();
                    return false;
                }
                ...
                Intent myIntent = new Intent(ErrorActivity.this, CaptchaActivity.class);
